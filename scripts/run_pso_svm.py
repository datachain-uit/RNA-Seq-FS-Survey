...
from src.features.pso_svm_selector import PSOSVMSelector
...
def main():
    ...
    parser.add_argument("--outdir", default="outputs/pso_svm/")
    ...
    selector = PSOSVMSelector(pop_size=20, num_generations=30)
    ...
    np.save(f"{args.outdir}/pso_mask.npy", mask)
    ...
    df.to_csv(f"{args.outdir}/metrics_pso.csv", index=False)

    print(df)
    print("PSO-SVM FS Completed.")
