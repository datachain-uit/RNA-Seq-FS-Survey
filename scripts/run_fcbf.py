...
from src.features.fcbf_selector import FCBFSelector
...
def main():
    ...
    parser.add_argument("--outdir", default="outputs/fcbf/")
    ...
    selector = FCBFSelector(k=args.k)
    ...
    np.save(f"{args.outdir}/fcbf_mask.npy", mask)
    ...
    df.to_csv(f"{args.outdir}/metrics_fcbf.csv", index=False)

    print(df)
    print("FCBF FS Completed.")
